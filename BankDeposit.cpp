...
public:
    ...
    StandardDeposit(const StandardDeposit& other);
...
public:
    ...
    CapitalizedDeposit(const CapitalizedDeposit& other);
...
public:
    ...
    PremiumDeposit(const PremiumDeposit& other);
...
double StandardDeposit::calculateCompoundInterest(int months) const {
    ...
    return initialAmount * std::pow(1.0 + (interestRate / 100.0), years);
}
